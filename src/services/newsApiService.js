...
export const getTrendingTopicsByKeyword = async (topic) => {
  try {
    ...
    const formattedArticles = data.articles.map((article, index) => ({
      ...
      url: article.url,
      imageUrl: article.urlToImage || `https://placehold.co/400x200/6366f1/white?text=${encodeURIComponent(topic)}`,
...
export const getTopHeadlines = async (category = 'technology') => {
  try {
    ...
    const formattedArticles = data.articles.map((article, index) => ({
      ...
      description: article.description || article.content?.substring(0, 150) || 'Sin descripci�n disponible',
      url: article.url,
      imageUrl: article.urlToImage || 'https://placehold.co/400x200/6366f1/white?text=News',
      source: article.source?.name || 'Fuente desconocida',
      publishedAt: article.publishedAt,
      author: article.author || 'Autor desconocido'
    }));
  ...
  return [
    {
      ...
      url: '#',
      imageUrl: `https://placehold.co/400x200/6366f1/white?text=${encodeURIComponent(topic)}`,
    ...
    },
    {
      ...
      url: '#',
      imageUrl: `https://placehold.co/400x200/8b5cf6/white?text=Estrategia`,
    ...
    },
    {
      ...
      url: '#',
      imageUrl: `https://placehold.co/400x200/a855f7/white?text=2025`,
    ...
    },
    {
      ...
      url: '#',
      imageUrl: `https://placehold.co/400x200/c084fc/white?text=Consejos`,
