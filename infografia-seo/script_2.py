...
# Ahora crear el archivo TypeScript/JavaScript con las utilidades del adaptador
adapter_code = '''// dataAdapter.js - Adaptador de datos SEO para infografías circulares
...
# Guardar el código del adaptador
with open('dataAdapter.js', 'w', encoding='utf-8') as f:
    f.write(adapter_code)

print("✓ Archivo generado: dataAdapter.js")
print("\nFunciones principales incluidas:")
print("  - adaptSEOData() - Transforma JSON de API a formato optimizado")
print("  - validatePayload() - Valida estructura de datos")
print("  - scaleSmart() - Normaliza métricas a escala 0-100")
print("  - formatNumber/Percent/Currency() - Formateo i18n")
print("  - polarToCartesian() - Conversión de coordenadas")
print("  - describeArc/DonutSegment() - Generadores de paths SVG")
