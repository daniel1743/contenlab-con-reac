-- ========================================
-- 🔧 CREAR FUNCIÓN consume_credits (VERSIÓN FINAL CORREGIDA)
-- ========================================
-- Adaptada a la estructura REAL de tu base de datos
-- Usa: subscription_tier (no subscription_plan)
-- ========================================
...
DECLARE
  ...
  v_feature_name TEXT;
BEGIN
  -- 1. Obtener el costo de la feature desde feature_credit_costs
